...
pub fn map_key(
    ...
    match mode {
        ...
        InputMode::Editing => map_editing_key(key, edit_normal, last_key),
...
fn map_editing_key(key: KeyEvent, is_normal: bool, last_key: Option<char>) -> Option<Action> {
    if is_normal {
        map_editing_normal_key(key, last_key)
    } else {
...
fn map_editing_normal_key(key: KeyEvent, last_key: Option<char>) -> Option<Action> {
    match key.code {
        ...
        KeyCode::Char(c) => match last_key {
            // Pending-key dispatch: r/f/F consume the next char as their argument.
...
mod tests {
    ...
    #[test]
    fn test_normal_move() {
        assert_eq!(map_key(key(KeyCode::Char('j')), &InputMode::Normal, None, false, false), Some(Action::MoveDown));
        assert_eq!(map_key(key(KeyCode::Down), &InputMode::Normal, None, false, false), Some(Action::MoveDown));
        assert_eq!(map_key(key(KeyCode::Char('k')), &InputMode::Normal, None, false, false), Some(Action::MoveUp));
        assert_eq!(map_key(key(KeyCode::Up), &InputMode::Normal, None, false, false), Some(Action::MoveUp));
        assert_eq!(map_key(key(KeyCode::Char('G')), &InputMode::Normal, None, false, false), Some(Action::MoveToBottom));
    }

    #[test]
    fn test_normal_gg() {
        // First 'g' returns None
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Normal, None, false, false), None);
        // Second 'g' returns MoveToTop
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Normal, Some('g'), false, false), Some(Action::MoveToTop));
    }

    #[test]
    fn test_normal_page_nav() {
        assert_eq!(map_key(ctrl('f'), &InputMode::Normal, None, false, false), Some(Action::PageDown));
        assert_eq!(map_key(ctrl('b'), &InputMode::Normal, None, false, false), Some(Action::PageUp));
    }

    #[test]
    fn test_normal_misc() {
        assert_eq!(map_key(key(KeyCode::Char('u')), &InputMode::Normal, None, false, false), Some(Action::Undo));
        assert_eq!(map_key(key(KeyCode::Char('/')), &InputMode::Normal, None, false, false), Some(Action::EnterSearch));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Normal, None, false, false), Some(Action::OpenDetail));
        assert_eq!(map_key(key(KeyCode::Char('a')), &InputMode::Normal, None, false, false), Some(Action::AddEntry));
        assert_eq!(map_key(key(KeyCode::Char('D')), &InputMode::Normal, None, false, false), Some(Action::DuplicateEntry));
        assert_eq!(map_key(key(KeyCode::Tab), &InputMode::Normal, None, false, false), Some(Action::ToggleGroups));
        assert_eq!(map_key(key(KeyCode::Char('B')), &InputMode::Normal, None, false, false), Some(Action::ToggleBraces));
        assert_eq!(map_key(key(KeyCode::Char('L')), &InputMode::Normal, None, false, false), Some(Action::ToggleLatex));
        assert_eq!(map_key(key(KeyCode::Char('S')), &InputMode::Normal, None, false, false), Some(Action::EnterSettings));
        assert_eq!(map_key(key(KeyCode::Char('?')), &InputMode::Normal, None, false, false), Some(Action::ShowHelp));
        assert_eq!(map_key(key(KeyCode::Char(':')), &InputMode::Normal, None, false, false), Some(Action::EnterCommand));
        assert_eq!(map_key(key(KeyCode::Char('I')), &InputMode::Normal, None, false, false), Some(Action::ImportEntry));
    }

    #[test]
    fn test_normal_dd() {
        assert_eq!(map_key(key(KeyCode::Char('d')), &InputMode::Normal, None, false, false), None);
        assert_eq!(map_key(key(KeyCode::Char('d')), &InputMode::Normal, Some('d'), false, false), Some(Action::DeleteEntry));
    }

    #[test]
    fn test_normal_yy() {
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Normal, None, false, false), None);
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Normal, Some('y'), false, false), Some(Action::YankCitekey));
    }

    #[test]
    fn test_normal_focus() {
        assert_eq!(map_key(key(KeyCode::Char('h')), &InputMode::Normal, None, false, false), Some(Action::FocusGroups));
        assert_eq!(map_key(key(KeyCode::Left), &InputMode::Normal, None, false, false), Some(Action::FocusGroups));
        assert_eq!(map_key(key(KeyCode::Char('l')), &InputMode::Normal, None, false, false), Some(Action::FocusList));
        assert_eq!(map_key(key(KeyCode::Right), &InputMode::Normal, None, false, false), Some(Action::FocusList));
    }
    ...
    #[test]
    fn test_search_mode() {
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Search, None, false, false), Some(Action::ExitSearch));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Search, None, false, false), Some(Action::ConfirmSearch));
        assert_eq!(map_key(key(KeyCode::Backspace), &InputMode::Search, None, false, false), Some(Action::SearchBackspace));
        assert_eq!(map_key(key(KeyCode::Char('x')), &InputMode::Search, None, false, false), Some(Action::SearchChar('x')));
    }
    ...
    #[test]
    fn test_detail_mode() {
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Detail, None, false, false), Some(Action::CloseDetail));
        assert_eq!(map_key(key(KeyCode::Char('q')), &InputMode::Detail, None, false, false), None);
        ...
        assert_eq!(map_key(key(KeyCode::Char('T')), &InputMode::Detail, None, false, false), Some(Action::TitlecaseField));
        assert_eq!(map_key(key(KeyCode::Char('N')), &InputMode::Detail, None, false, false), Some(Action::DetailPrevMatch));
        ...
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Detail, Some('g'), false, false), Some(Action::MoveToTop));
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Detail, None, false, false), None);
        assert_eq!(map_key(ctrl('f'), &InputMode::Detail, None, false, false), Some(Action::PageDown));
        assert_eq!(map_key(ctrl('b'), &InputMode::Detail, None, false, false), Some(Action::PageUp));
        // Group editing moved to Tab
        assert_eq!(map_key(key(KeyCode::Tab), &InputMode::Detail, None, false, false), Some(Action::EditGroups));
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Detail, Some('x'), false, false), None);
    }
    ...
    fn test_editing_mode() {
        ...
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Editing, None, false, false), Some(Action::EditEnterNormal));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Editing, None, false, false), Some(Action::ConfirmEdit));
        assert_eq!(map_key(key(KeyCode::Backspace), &InputMode::Editing, None, false, false), Some(Action::EditBackspace));
        assert_eq!(map_key(key(KeyCode::Left), &InputMode::Editing, None, false, false), Some(Action::EditCursorLeft));
        assert_eq!(map_key(key(KeyCode::Right), &InputMode::Editing, None, false, false), Some(Action::EditCursorRight));
        assert_eq!(map_key(key(KeyCode::Delete), &InputMode::Editing, None, false, false), Some(Action::EditDelete));
        assert_eq!(map_key(ctrl('a'), &InputMode::Editing, None, false, false), Some(Action::EditCursorHome));
        assert_eq!(map_key(ctrl('e'), &InputMode::Editing, None, false, false), Some(Action::EditCursorEnd));
        assert_eq!(map_key(key(KeyCode::Char('z')), &InputMode::Editing, None, false, false), Some(Action::EditChar('z')));
    }
    ...
    fn test_editing_mode_up_down() {
        ...
        assert_eq!(
            map_key(key(KeyCode::Up), &InputMode::Editing, None, false, false),
            Some(Action::EditCursorUp)
        );
        assert_eq!(
            map_key(key(KeyCode::Down), &InputMode::Editing, None, false, false),
    ...
    fn test_editing_mode_home_end() {
        ...
        assert_eq!(
            map_key(
                ...
                &InputMode::Editing, None, false, false
            ),
            Some(Action::EditCursorHome)
        );
        assert_eq!(
        ...
        assert_eq!(
            map_key(key(KeyCode::Home), &InputMode::Editing, None, false, false),
            None
        );
    }
    ...
    fn test_editing_mode_tab() {
        assert_eq!(
            map_key(key(KeyCode::Tab), &InputMode::Editing, None, false, false),
    ...
    fn test_dialog_mode() {
        ...
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Dialog, None, false, false), Some(Action::DialogCancel));
        assert_eq!(map_key(key(KeyCode::Char('n')), &InputMode::Dialog, None, false, false), Some(Action::DialogCancel));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Dialog, None, false, false), Some(Action::DialogConfirm));
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Dialog, None, false, false), Some(Action::DialogConfirm));
        assert_eq!(map_key(key(KeyCode::Char('j')), &InputMode::Dialog, None, false, false), Some(Action::MoveDown));
        assert_eq!(map_key(key(KeyCode::Char('k')), &InputMode::Dialog, None, false, false), Some(Action::MoveUp));
        assert_eq!(map_key(key(KeyCode::Char(' ')), &InputMode::Dialog, None, false, false), Some(Action::DialogToggle));
        assert_eq!(map_key(ctrl('f'), &InputMode::Dialog, None, false, false), Some(Action::PageDown));
        assert_eq!(map_key(ctrl('b'), &InputMode::Dialog, None, false, false), Some(Action::PageUp));
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Dialog, None, false, false), Some(Action::MoveToTop));
        assert_eq!(map_key(key(KeyCode::Char('G')), &InputMode::Dialog, None, false, false), Some(Action::MoveToBottom));
    }

    #[test]
    fn test_message_dialog_yy() {
        // In a Message dialog: first 'y' does nothing (pending chord)
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Dialog, None, true, false), None);
        // Second 'y' (yy) yanks the message
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Dialog, Some('y'), true, false), Some(Action::DialogYank));
        // Enter still dismisses
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Dialog, None, true, false), Some(Action::DialogConfirm));
        // Esc still cancels
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Dialog, None, true, false), Some(Action::DialogCancel));
    }
    ...
    fn test_command_mode() {
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Command, None, false, false), Some(Action::ExitCommand));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Command, None, false, false), Some(Action::ExecuteCommand));
        assert_eq!(map_key(key(KeyCode::Backspace), &InputMode::Command, None, false, false), Some(Action::CommandBackspace));
        assert_eq!(map_key(key(KeyCode::Char('w')), &InputMode::Command, None, false, false), Some(Action::CommandChar('w')));
    }
    ...
    fn test_settings_mode() {
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Settings, None, false, false), Some(Action::ExitSettings));
        assert_eq!(map_key(key(KeyCode::Char('q')), &InputMode::Settings, None, false, false), None);
        assert_eq!(map_key(key(KeyCode::Char('j')), &InputMode::Settings, None, false, false), Some(Action::SettingsMoveDown));
        assert_eq!(map_key(key(KeyCode::Down), &InputMode::Settings, None, false, false), Some(Action::SettingsMoveDown));
        assert_eq!(map_key(key(KeyCode::Char('k')), &InputMode::Settings, None, false, false), Some(Action::SettingsMoveUp));
        assert_eq!(map_key(key(KeyCode::Char('g')), &InputMode::Settings, None, false, false), Some(Action::SettingsMoveToTop));
        assert_eq!(map_key(key(KeyCode::Char('G')), &InputMode::Settings, None, false, false), Some(Action::SettingsMoveToBottom));
        assert_eq!(map_key(ctrl('f'), &InputMode::Settings, None, false, false), Some(Action::SettingsPageDown));
        assert_eq!(map_key(ctrl('b'), &InputMode::Settings, None, false, false), Some(Action::SettingsPageUp));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Settings, None, false, false), Some(Action::SettingsToggle));
        assert_eq!(map_key(key(KeyCode::Char(' ')), &InputMode::Settings, None, false, false), Some(Action::SettingsToggle));
        assert_eq!(map_key(key(KeyCode::Char('e')), &InputMode::Settings, None, false, false), Some(Action::SettingsEdit));
        assert_eq!(map_key(key(KeyCode::Char('E')), &InputMode::Settings, None, false, false), Some(Action::SettingsExport));
        assert_eq!(map_key(key(KeyCode::Char('I')), &InputMode::Settings, None, false, false), Some(Action::SettingsImport));
    }

    #[test]
    fn test_normal_mode_extra_keys() {
        assert_eq!(map_key(key(KeyCode::Char(' ')), &InputMode::Normal, None, false, false), Some(Action::ShowCitationPreview));
        assert_eq!(map_key(key(KeyCode::Char('o')), &InputMode::Normal, None, false, false), Some(Action::OpenFile));
        assert_eq!(map_key(key(KeyCode::Char('w')), &InputMode::Normal, None, false, false), Some(Action::OpenWeb));
        assert_eq!(map_key(key(KeyCode::Char('v')), &InputMode::Normal, None, false, false), Some(Action::Validate));
        // Unknown key → None
        assert_eq!(map_key(key(KeyCode::F(1)), &InputMode::Normal, None, false, false), None);
    }

    #[test]
    fn test_search_mode_unknown_key() {
        assert_eq!(map_key(key(KeyCode::F(1)), &InputMode::Search, None, false, false), None);
    }

    #[test]
    fn test_detail_mode_extra_keys() {
        assert_eq!(map_key(key(KeyCode::Char('o')), &InputMode::Detail, None, false, false), Some(Action::OpenFile));
        assert_eq!(map_key(key(KeyCode::Char('w')), &InputMode::Detail, None, false, false), Some(Action::OpenWeb));
        assert_eq!(map_key(key(KeyCode::Char('L')), &InputMode::Detail, None, false, false), Some(Action::ToggleLatex));
        assert_eq!(map_key(key(KeyCode::Char('B')), &InputMode::Detail, None, false, false), Some(Action::ToggleBraces));
    }
    ...
    fn test_detail_search_mode() {
        assert_eq!(map_key(key(KeyCode::Esc),       &InputMode::DetailSearch, None, false, false), Some(Action::ExitDetailSearch));
        assert_eq!(map_key(key(KeyCode::Enter),     &InputMode::DetailSearch, None, false, false), Some(Action::ExitDetailSearch));
        assert_eq!(map_key(key(KeyCode::Backspace), &InputMode::DetailSearch, None, false, false), Some(Action::DetailSearchBackspace));
        assert_eq!(map_key(key(KeyCode::Char('a')), &InputMode::DetailSearch, None, false, false), Some(Action::DetailSearchChar('a')));
        assert_eq!(map_key(key(KeyCode::F(1)),      &InputMode::DetailSearch, None, false, false), None);
    }
    ...
    fn test_help_mode() {
        ...
        assert_eq!(map_key(key(KeyCode::Esc),       &InputMode::Help, None, false, false), Some(Action::CloseHelp));
        assert_eq!(map_key(key(KeyCode::Char('q')), &InputMode::Help, None, false, false), Some(Action::CloseHelp));
    }
    ...
    fn test_dialog_unknown_key() {
        assert_eq!(map_key(key(KeyCode::F(1)), &InputMode::Dialog, None, false, false), None);
    }
    ...
    fn test_command_mode_extra_keys() {
        assert_eq!(map_key(key(KeyCode::Tab),   &InputMode::Command, None, false, false), Some(Action::CommandTabComplete));
        assert_eq!(map_key(key(KeyCode::F(1)),  &InputMode::Command, None, false, false), None);
    }
    ...
    fn test_settings_mode_field_group_ops() {
        assert_eq!(map_key(key(KeyCode::Char('a')), &InputMode::Settings, None, false, false), Some(Action::SettingsAddFieldGroup));
        assert_eq!(map_key(key(KeyCode::Char('x')), &InputMode::Settings, None, false, false), Some(Action::SettingsDeleteFieldGroup));
        assert_eq!(map_key(key(KeyCode::Char('r')), &InputMode::Settings, None, false, false), Some(Action::SettingsRenameFieldGroup));
    }
    ...
    fn test_validate_results_mode() {
        assert_eq!(map_key(key(KeyCode::Char('j')), &InputMode::ValidateResults, None, false, false), Some(Action::MoveDown));
        assert_eq!(map_key(key(KeyCode::Down),      &InputMode::ValidateResults, None, false, false), Some(Action::MoveDown));
        assert_eq!(map_key(key(KeyCode::Char('k')), &InputMode::ValidateResults, None, false, false), Some(Action::MoveUp));
        assert_eq!(map_key(key(KeyCode::Up),        &InputMode::ValidateResults, None, false, false), Some(Action::MoveUp));
        assert_eq!(map_key(key(KeyCode::Esc),       &InputMode::ValidateResults, None, false, false), Some(Action::CloseValidateResults));
        assert_eq!(map_key(key(KeyCode::Char('q')), &InputMode::ValidateResults, None, false, false), Some(Action::CloseValidateResults));
        assert_eq!(map_key(key(KeyCode::F(1)),      &InputMode::ValidateResults, None, false, false), None);
    }
    ...
    fn test_citation_preview_mode() {
        assert_eq!(
            map_key(key(KeyCode::Esc), &InputMode::CitationPreview, None, false, false),
            Some(Action::CloseCitationPreview)
        );
        assert_eq!(
            map_key(key(KeyCode::Char('q')), &InputMode::CitationPreview, None, false, false),
            Some(Action::CloseCitationPreview)
        );
        assert_eq!(
            map_key(key(KeyCode::Char('j')), &InputMode::CitationPreview, None, false, false),
            Some(Action::MoveDown)
        );
        assert_eq!(
            map_key(key(KeyCode::Char('k')), &InputMode::CitationPreview, None, false, false),
            Some(Action::MoveUp)
        );
    }
    ...
    fn test_editing_normal_mode_keys() {
        ...
        assert_eq!(map_key(key(KeyCode::Esc), &InputMode::Editing, None, false, true), Some(Action::CancelEdit));
        assert_eq!(map_key(key(KeyCode::Enter), &InputMode::Editing, None, false, true), Some(Action::ConfirmEdit));
        // Mode transitions
        assert_eq!(map_key(key(KeyCode::Char('i')), &InputMode::Editing, None, false, true), Some(Action::EditEnterInsert));
        assert_eq!(map_key(key(KeyCode::Char('a')), &InputMode::Editing, None, false, true), Some(Action::EditEnterInsertAfter));
        assert_eq!(map_key(key(KeyCode::Char('A')), &InputMode::Editing, None, false, true), Some(Action::EditEnterInsertAtEnd));
        assert_eq!(map_key(key(KeyCode::Char('I')), &InputMode::Editing, None, false, true), Some(Action::EditEnterInsertAtHome));
        // Navigation
        assert_eq!(map_key(key(KeyCode::Char('h')), &InputMode::Editing, None, false, true), Some(Action::EditCursorLeft));
        assert_eq!(map_key(key(KeyCode::Left), &InputMode::Editing, None, false, true), Some(Action::EditCursorLeft));
        assert_eq!(map_key(key(KeyCode::Char('l')), &InputMode::Editing, None, false, true), Some(Action::EditCursorRight));
        assert_eq!(map_key(key(KeyCode::Right), &InputMode::Editing, None, false, true), Some(Action::EditCursorRight));
        assert_eq!(map_key(key(KeyCode::Char('0')), &InputMode::Editing, None, false, true), Some(Action::EditCursorHome));
        assert_eq!(map_key(key(KeyCode::Home), &InputMode::Editing, None, false, true), Some(Action::EditCursorHome));
        assert_eq!(map_key(key(KeyCode::Char('$')), &InputMode::Editing, None, false, true), Some(Action::EditCursorEnd));
        assert_eq!(map_key(key(KeyCode::End), &InputMode::Editing, None, false, true), Some(Action::EditCursorEnd));
        // Delete
        assert_eq!(map_key(key(KeyCode::Char('x')), &InputMode::Editing, None, false, true), Some(Action::EditDelete));
        // Word motions
        assert_eq!(map_key(key(KeyCode::Char('w')), &InputMode::Editing, None, false, true), Some(Action::EditMoveWordFwd));
        assert_eq!(map_key(key(KeyCode::Char('b')), &InputMode::Editing, None, false, true), Some(Action::EditMoveWordBwd));
        assert_eq!(map_key(key(KeyCode::Char('e')), &InputMode::Editing, None, false, true), Some(Action::EditMoveWordEnd));
        assert_eq!(map_key(key(KeyCode::Char('W')), &InputMode::Editing, None, false, true), Some(Action::EditMoveBigWordFwd));
        assert_eq!(map_key(key(KeyCode::Char('B')), &InputMode::Editing, None, false, true), Some(Action::EditMoveBigWordBwd));
        assert_eq!(map_key(key(KeyCode::Char('E')), &InputMode::Editing, None, false, true), Some(Action::EditMoveBigWordEnd));
        // Undo / put / yank
        assert_eq!(map_key(key(KeyCode::Char('u')), &InputMode::Editing, None, false, true), Some(Action::EditUndo));
        assert_eq!(map_key(key(KeyCode::Char('p')), &InputMode::Editing, None, false, true), Some(Action::EditPut));
        // First 'y' is pending (no last_key)
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Editing, None, false, true), None);
        // Second 'y' yanks
        assert_eq!(map_key(key(KeyCode::Char('y')), &InputMode::Editing, Some('y'), false, true), Some(Action::EditYank));
        // j/k navigate fields
        assert_eq!(map_key(key(KeyCode::Char('j')), &InputMode::Editing, None, false, true), Some(Action::EditConfirmAndMoveDown));
        assert_eq!(map_key(key(KeyCode::Char('k')), &InputMode::Editing, None, false, true), Some(Action::EditConfirmAndMoveUp));
        assert_eq!(map_key(key(KeyCode::Down), &InputMode::Editing, None, false, true), Some(Action::EditConfirmAndMoveDown));
        assert_eq!(map_key(key(KeyCode::Up), &InputMode::Editing, None, false, true), Some(Action::EditConfirmAndMoveUp));
        // New operators
        assert_eq!(map_key(key(KeyCode::Char('D')), &InputMode::Editing, None, false, true), Some(Action::EditDeleteToEnd));
        assert_eq!(map_key(key(KeyCode::Char('C')), &InputMode::Editing, None, false, true), Some(Action::EditChangeToEnd));
        assert_eq!(map_key(key(KeyCode::Char('s')), &InputMode::Editing, None, false, true), Some(Action::EditSubstituteChar));
        assert_eq!(map_key(key(KeyCode::Char('S')), &InputMode::Editing, None, false, true), Some(Action::EditSubstituteLine));
        assert_eq!(map_key(key(KeyCode::Char('~')), &InputMode::Editing, None, false, true), Some(Action::EditToggleCase));
        assert_eq!(map_key(key(KeyCode::Char('X')), &InputMode::Editing, None, false, true), Some(Action::EditDeleteCharBack));
        // Pending keys return None alone
        assert_eq!(map_key(key(KeyCode::Char('r')), &InputMode::Editing, None, false, true), None);
        assert_eq!(map_key(key(KeyCode::Char('f')), &InputMode::Editing, None, false, true), None);
        assert_eq!(map_key(key(KeyCode::Char('F')), &InputMode::Editing, None, false, true), None);
        // Pending keys dispatch on next char
        assert_eq!(map_key(key(KeyCode::Char('x')), &InputMode::Editing, Some('r'), false, true), Some(Action::EditReplaceChar('x')));
        assert_eq!(map_key(key(KeyCode::Char('.')), &InputMode::Editing, Some('f'), false, true), Some(Action::EditFindCharFwd('.')));
        assert_eq!(map_key(key(KeyCode::Char('.')), &InputMode::Editing, Some('F'), false, true), Some(Action::EditFindCharBwd('.')));
        // dw still works
        assert_eq!(map_key(key(KeyCode::Char('w')), &InputMode::Editing, Some('d'), false, true), Some(Action::EditDeleteWordFwd));
        // Unknown key → None
        assert_eq!(map_key(key(KeyCode::Char('z')), &InputMode::Editing, None, false, true), None);
    }
    ...
    fn test_editing_insert_ctrl_keys() {
        ...
        assert_eq!(map_key(ctrl_w, &InputMode::Editing, None, false, false), Some(Action::EditDeleteWordBack));
        assert_eq!(map_key(ctrl_u, &InputMode::Editing, None, false, false), Some(Action::EditDeleteToHome));
    }
    ...
    fn test_citation_preview_yy() {
        ...
        assert_eq!(
            map_key(key(KeyCode::Char('y')), &InputMode::CitationPreview, None, false, false),
            None
        );
